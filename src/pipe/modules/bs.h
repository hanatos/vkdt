...
typedef struct dt_connector_image_t dt_connector_image_t;
...
DECLARE_FUNC(dt_connector_image_t*, dt_graph_connector_image, (dt_graph_t *graph, int nid, int cid, int a, int d));
...
dt_module_bs_init()
{
  ...
  LOAD_FUNCC(dt_graph_connector_image);
  return 0;
}
#endif
