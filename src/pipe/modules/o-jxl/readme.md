...
* `effort` 1-10. higher values allow more computation. for lossless this generally achieves smaller file sizes. for lossy this should result in better visual quality at a given filesize, but also greater conformance to the specified quality. importantly this can sometimes mean larger (but higher quality) images than at lower effort levels.
