    ...
    dt_module_t *module)
{
  ...
  {
    // TODO: need a NLR downsample kernel NLR_Downsample.compute
    // TODO: need combine kernel NLR_Combine.compute
    // TODO: need a NLR upsample kernel NLR_DenoiseUpsample.compute
