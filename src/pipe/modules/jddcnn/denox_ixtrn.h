#ifndef jddcnn_ixtrn_DENOX_MODULE_H
#define jddcnn_ixtrn_DENOX_MODULE_H
...
static int denox_read_source_ixtrn(dt_module_t* mod, void* mapped, dt_read_source_params_t* p) {
  if (p->node->kernel == dt_token("weights")) {
    FILE* f = dt_graph_open_resource(mod->graph, 0, "data/jddcnn-ixtrn.dat", "rb");
    if (!f) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: could not find \"data/jddcnn-ixtrn.dat\"");
      return 1;
    }
    fseek(f, 0, SEEK_END);
    ...
    if (size != expected_size) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: weight file \"data/jddcnn-ixtrn.dat\" has unexpected size!");
      fclose(f);
      return 1;
    }
    fseek(f, 0, SEEK_SET);
...
static void denox_create_nodes_ixtrn(dt_graph_t* graph, dt_module_t* module,
  ...
  const int memory_pad_id = dt_node_add(graph, module, "jddcnn", "ixtrn6",
  ...
  const int direct_conv_cm_id = dt_node_add(graph, module, "jddcnn", "ixtrn16",
  ...
  const int direct_conv_cm_1_id = dt_node_add(graph, module, "jddcnn", "ixtrn13",
      1 * DT_LOCAL_SIZE_X, r113 * DT_LOCAL_SIZE_Y, r99,
  ...
  const int direct_conv_cm_2_id = dt_node_add(graph, module, "jddcnn", "ixtrn12",
  ...
  const int direct_conv_cm_3_id = dt_node_add(graph, module, "jddcnn", "ixtrn10",
  ...
  const int direct_conv_cm_4_id = dt_node_add(graph, module, "jddcnn", "ixtrn11",
  ...
  const int direct_conv_cm_5_id = dt_node_add(graph, module, "jddcnn", "ixtrn17",
  ...
  const int direct_conv_cm_6_id = dt_node_add(graph, module, "jddcnn", "ixtrn20",
  ...
  const int direct_conv_cm_7_id = dt_node_add(graph, module, "jddcnn", "ixtrn14",
  ...
  const int direct_conv_cm_8_id = dt_node_add(graph, module, "jddcnn", "ixtrn7",
  ...
  const int direct_conv_cm_9_id = dt_node_add(graph, module, "jddcnn", "ixtrn21",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r68,
  ...
  const int concat_conv_cm_id = dt_node_add(graph, module, "jddcnn", "ixtrn19",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r68,
  ...
  const int direct_conv_cm_10_id = dt_node_add(graph, module, "jddcnn", "ixtrn20",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r68,
  ...
  const int direct_conv_cm_11_id = dt_node_add(graph, module, "jddcnn", "ixtrn9",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r80,
  ...
  const int concat_conv_cm_1_id = dt_node_add(graph, module, "jddcnn", "ixtrn18",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r76,
  ...
  const int direct_conv_cm_12_id = dt_node_add(graph, module, "jddcnn", "ixtrn5",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r76,
  ...
  const int direct_conv_cm_13_id = dt_node_add(graph, module, "jddcnn", "ixtrn4",
      1 * DT_LOCAL_SIZE_X, r97 * DT_LOCAL_SIZE_Y, r95,
  ...
  const int direct_conv_cm_14_id = dt_node_add(graph, module, "jddcnn", "ixtrn3",
      1 * DT_LOCAL_SIZE_X, r97 * DT_LOCAL_SIZE_Y, r95,
  ...
  const int direct_conv_cm_15_id = dt_node_add(graph, module, "jddcnn", "ixtrn8",
      1 * DT_LOCAL_SIZE_X, r97 * DT_LOCAL_SIZE_Y, r95,
  ...
  const int direct_conv_cm_16_id = dt_node_add(graph, module, "jddcnn", "ixtrn2",
  ...
  const int concat_conv_cm_2_id = dt_node_add(graph, module, "jddcnn", "ixtrn1",
  ...
  const int direct_conv_cm_17_id = dt_node_add(graph, module, "jddcnn", "ixtrn15",
  ...
  const int memory_slice_id = dt_node_add(graph, module, "jddcnn", "ixtrn0",
