#ifndef jddcnn_nxtrc_DENOX_MODULE_H
#define jddcnn_nxtrc_DENOX_MODULE_H
...
static int denox_read_source_nxtrc(dt_module_t* mod, void* mapped, dt_read_source_params_t* p) {
  if (p->node->kernel == dt_token("weights")) {
    FILE* f = dt_graph_open_resource(mod->graph, 0, "data/jddcnn-nxtrc.dat", "rb");
    if (!f) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: could not find \"data/jddcnn-nxtrc.dat\"");
      return 1;
    }
    fseek(f, 0, SEEK_END);
    ...
    if (size != expected_size) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: weight file \"data/jddcnn-nxtrc.dat\" has unexpected size!");
      fclose(f);
      return 1;
    }
    fseek(f, 0, SEEK_SET);
...
static void denox_create_nodes_nxtrc(dt_graph_t* graph, dt_module_t* module,
  ...
  const int memory_pad_id = dt_node_add(graph, module, "jddcnn", "nxtrc7",
  ...
  const int direct_conv_cm_id = dt_node_add(graph, module, "jddcnn", "nxtrc9",
  ...
  const int direct_conv_cm_1_id = dt_node_add(graph, module, "jddcnn", "nxtrc10",
  ...
  const int direct_conv_cm_2_id = dt_node_add(graph, module, "jddcnn", "nxtrc19",
  ...
  const int direct_conv_cm_3_id = dt_node_add(graph, module, "jddcnn", "nxtrc11",
      1 * DT_LOCAL_SIZE_X, r95 * DT_LOCAL_SIZE_Y, r89,
  ...
  const int direct_conv_cm_4_id = dt_node_add(graph, module, "jddcnn", "nxtrc13",
  ...
  const int direct_conv_cm_5_id = dt_node_add(graph, module, "jddcnn", "nxtrc15",
      1 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r76,
  ...
  const int direct_conv_cm_6_id = dt_node_add(graph, module, "jddcnn", "nxtrc14",
  ...
  const int direct_conv_cm_7_id = dt_node_add(graph, module, "jddcnn", "nxtrc16",
  ...
  const int direct_conv_cm_8_id = dt_node_add(graph, module, "jddcnn", "nxtrc12",
  ...
  const int direct_conv_cm_9_id = dt_node_add(graph, module, "jddcnn", "nxtrc18",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r64,
  ...
  const int concat_conv_cm_id = dt_node_add(graph, module, "jddcnn", "nxtrc20",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r68,
  ...
  const int direct_conv_cm_10_id = dt_node_add(graph, module, "jddcnn", "nxtrc14",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r64,
  ...
  const int direct_conv_cm_11_id = dt_node_add(graph, module, "jddcnn", "nxtrc8",
      1 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r76,
  ...
  const int concat_conv_cm_1_id = dt_node_add(graph, module, "jddcnn", "nxtrc5",
      1 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r76,
  ...
  const int direct_conv_cm_12_id = dt_node_add(graph, module, "jddcnn", "nxtrc4",
      1 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r76,
  ...
  const int direct_conv_cm_13_id = dt_node_add(graph, module, "jddcnn", "nxtrc17",
  ...
  const int concat_conv_cm_2_id = dt_node_add(graph, module, "jddcnn", "nxtrc3",
      1 * DT_LOCAL_SIZE_X, r95 * DT_LOCAL_SIZE_Y, r89,
  ...
  const int direct_conv_cm_14_id = dt_node_add(graph, module, "jddcnn", "nxtrc19",
      1 * DT_LOCAL_SIZE_X, r95 * DT_LOCAL_SIZE_Y, r89,
  ...
  const int direct_conv_cm_15_id = dt_node_add(graph, module, "jddcnn", "nxtrc2",
  ...
  const int concat_conv_cm_3_id = dt_node_add(graph, module, "jddcnn", "nxtrc1",
      1 * DT_LOCAL_SIZE_X, r109 * DT_LOCAL_SIZE_Y, r103,
  ...
  const int direct_conv_cm_16_id = dt_node_add(graph, module, "jddcnn", "nxtrc0",
      1 * DT_LOCAL_SIZE_X, r109 * DT_LOCAL_SIZE_Y, r101,
  ...
  const int memory_slice_id = dt_node_add(graph, module, "jddcnn", "nxtrc6",
