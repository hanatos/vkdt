#ifndef jddcnn_nbyrc_DENOX_MODULE_H
#define jddcnn_nbyrc_DENOX_MODULE_H
...
static int denox_read_source_nbyrc(dt_module_t* mod, void* mapped, dt_read_source_params_t* p) {
  if (p->node->kernel == dt_token("weights")) {
    FILE* f = dt_graph_open_resource(mod->graph, 0, "data/jddcnn-nbyrc.dat", "rb");
    if (!f) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: could not find \"data/jddcnn-nbyrc.dat\"");
      return 1;
    }
    fseek(f, 0, SEEK_END);
    ...
    if (size != expected_size) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: weight file \"data/jddcnn-nbyrc.dat\" has unexpected size!");
      fclose(f);
      return 1;
    }
    fseek(f, 0, SEEK_SET);
...
static void denox_create_nodes_nbyrc(dt_graph_t* graph, dt_module_t* module,
  ...
  const int memory_pad_id = dt_node_add(graph, module, "jddcnn", "nbyrc4",
  ...
  const int direct_conv_cm_id = dt_node_add(graph, module, "jddcnn", "nbyrc7",
  ...
  const int direct_conv_cm_1_id = dt_node_add(graph, module, "jddcnn", "nbyrc5",
  ...
  const int direct_conv_cm_2_id = dt_node_add(graph, module, "jddcnn", "nbyrc17",
  ...
  const int direct_conv_cm_3_id = dt_node_add(graph, module, "jddcnn", "nbyrc9",
      1 * DT_LOCAL_SIZE_X, r96 * DT_LOCAL_SIZE_Y, r90,
  ...
  const int direct_conv_cm_4_id = dt_node_add(graph, module, "jddcnn", "nbyrc10",
  ...
  const int direct_conv_cm_5_id = dt_node_add(graph, module, "jddcnn", "nbyrc12",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r78,
  ...
  const int direct_conv_cm_6_id = dt_node_add(graph, module, "jddcnn", "nbyrc11",
  ...
  const int direct_conv_cm_7_id = dt_node_add(graph, module, "jddcnn", "nbyrc13",
  ...
  const int direct_conv_cm_8_id = dt_node_add(graph, module, "jddcnn", "nbyrc8",
  ...
  const int direct_conv_cm_9_id = dt_node_add(graph, module, "jddcnn", "nbyrc15",
      1 * DT_LOCAL_SIZE_X, r72 * DT_LOCAL_SIZE_Y, r66,
  ...
  const int concat_conv_cm_id = dt_node_add(graph, module, "jddcnn", "nbyrc18",
      1 * DT_LOCAL_SIZE_X, r72 * DT_LOCAL_SIZE_Y, r70,
  ...
  const int direct_conv_cm_10_id = dt_node_add(graph, module, "jddcnn", "nbyrc11",
      1 * DT_LOCAL_SIZE_X, r72 * DT_LOCAL_SIZE_Y, r66,
  ...
  const int direct_conv_cm_11_id = dt_node_add(graph, module, "jddcnn", "nbyrc20",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r78,
  ...
  const int concat_conv_cm_1_id = dt_node_add(graph, module, "jddcnn", "nbyrc3",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r78,
  ...
  const int direct_conv_cm_12_id = dt_node_add(graph, module, "jddcnn", "nbyrc2",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r78,
  ...
  const int direct_conv_cm_13_id = dt_node_add(graph, module, "jddcnn", "nbyrc14",
  ...
  const int concat_conv_cm_2_id = dt_node_add(graph, module, "jddcnn", "nbyrc1",
      1 * DT_LOCAL_SIZE_X, r96 * DT_LOCAL_SIZE_Y, r90,
  ...
  const int direct_conv_cm_14_id = dt_node_add(graph, module, "jddcnn", "nbyrc17",
      1 * DT_LOCAL_SIZE_X, r96 * DT_LOCAL_SIZE_Y, r90,
  ...
  const int direct_conv_cm_15_id = dt_node_add(graph, module, "jddcnn", "nbyrc6",
  ...
  const int concat_conv_cm_3_id = dt_node_add(graph, module, "jddcnn", "nbyrc19",
      1 * DT_LOCAL_SIZE_X, r113 * DT_LOCAL_SIZE_Y, r109,
  ...
  const int direct_conv_cm_16_id = dt_node_add(graph, module, "jddcnn", "nbyrc16",
      1 * DT_LOCAL_SIZE_X, r113 * DT_LOCAL_SIZE_Y, r107,
  ...
  const int memory_slice_id = dt_node_add(graph, module, "jddcnn", "nbyrc0",
