#ifndef jddcnn_gbyrn_DENOX_MODULE_H
#define jddcnn_gbyrn_DENOX_MODULE_H
...
static int denox_read_source_gbyrn(dt_module_t* mod, void* mapped, dt_read_source_params_t* p) {
  if (p->node->kernel == dt_token("weights")) {
    FILE* f = dt_graph_open_resource(mod->graph, 0, "data/jddcnn-gbyrn.dat", "rb");
    if (!f) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: could not find \"data/jddcnn-gbyrn.dat\"");
      return 1;
    }
    fseek(f, 0, SEEK_END);
    ...
    if (size != expected_size) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: weight file \"data/jddcnn-gbyrn.dat\" has unexpected size!");
      fclose(f);
      return 1;
    }
    fseek(f, 0, SEEK_SET);
...
static void denox_create_nodes_gbyrn(dt_graph_t* graph, dt_module_t* module,
  ...
  const int memory_pad_id = dt_node_add(graph, module, "jddcnn", "gbyrn25",
  ...
  const int direct_conv_id = dt_node_add(graph, module, "jddcnn", "gbyrn24",
  ...
  const int basic_activation_id = dt_node_add(graph, module, "jddcnn", "gbyrn16",
  ...
  const int direct_conv_1_id = dt_node_add(graph, module, "jddcnn", "gbyrn15",
      1 * DT_LOCAL_SIZE_X, r157 * DT_LOCAL_SIZE_Y, r155,
  ...
  const int basic_activation_1_id = dt_node_add(graph, module, "jddcnn", "gbyrn20",
  ...
  const int basic_pool_id = dt_node_add(graph, module, "jddcnn", "gbyrn17",
  ...
  const int direct_conv_2_id = dt_node_add(graph, module, "jddcnn", "gbyrn13",
  ...
  const int basic_activation_2_id = dt_node_add(graph, module, "jddcnn", "gbyrn8",
  ...
  const int direct_conv_3_id = dt_node_add(graph, module, "jddcnn", "gbyrn14",
  ...
  const int basic_activation_3_id = dt_node_add(graph, module, "jddcnn", "gbyrn33",
  ...
  const int basic_pool_1_id = dt_node_add(graph, module, "jddcnn", "gbyrn21",
  ...
  const int direct_conv_4_id = dt_node_add(graph, module, "jddcnn", "gbyrn6",
  ...
  const int basic_activation_4_id = dt_node_add(graph, module, "jddcnn", "gbyrn11",
  ...
  const int direct_conv_5_id = dt_node_add(graph, module, "jddcnn", "gbyrn22",
      1 * DT_LOCAL_SIZE_X, r121 * DT_LOCAL_SIZE_Y, r115,
  ...
  const int basic_activation_5_id = dt_node_add(graph, module, "jddcnn", "gbyrn26",
  ...
  const int basic_pool_2_id = dt_node_add(graph, module, "jddcnn", "gbyrn27",
  ...
  const int direct_conv_6_id = dt_node_add(graph, module, "jddcnn", "gbyrn10",
  ...
  const int basic_activation_6_id = dt_node_add(graph, module, "jddcnn", "gbyrn18",
      16 * DT_LOCAL_SIZE_X, r78 * DT_LOCAL_SIZE_Y, r15,
  ...
  const int direct_conv_7_id = dt_node_add(graph, module, "jddcnn", "gbyrn29",
  ...
  const int basic_activation_7_id = dt_node_add(graph, module, "jddcnn", "gbyrn31",
  ...
  const int basic_pool_3_id = dt_node_add(graph, module, "jddcnn", "gbyrn12",
  ...
  const int direct_conv_8_id = dt_node_add(graph, module, "jddcnn", "gbyrn19",
  ...
  const int basic_activation_8_id = dt_node_add(graph, module, "jddcnn", "gbyrn32",
  ...
  const int basic_upsample_id = dt_node_add(graph, module, "jddcnn", "gbyrn7",
  ...
  const int direct_conv_9_id = dt_node_add(graph, module, "jddcnn", "gbyrn34",
      1 * DT_LOCAL_SIZE_X, r108 * DT_LOCAL_SIZE_Y, r100,
  ...
  const int basic_activation_9_id = dt_node_add(graph, module, "jddcnn", "gbyrn18",
      16 * DT_LOCAL_SIZE_X, r78 * DT_LOCAL_SIZE_Y, r15,
  ...
  const int direct_conv_10_id = dt_node_add(graph, module, "jddcnn", "gbyrn34",
      1 * DT_LOCAL_SIZE_X, r108 * DT_LOCAL_SIZE_Y, r100,
  ...
  const int basic_activation_10_id = dt_node_add(graph, module, "jddcnn", "gbyrn18",
      16 * DT_LOCAL_SIZE_X, r78 * DT_LOCAL_SIZE_Y, r15,
  ...
  const int direct_conv_11_id = dt_node_add(graph, module, "jddcnn", "gbyrn10",
      1 * DT_LOCAL_SIZE_X, r108 * DT_LOCAL_SIZE_Y, r100,
  ...
  const int basic_activation_11_id = dt_node_add(graph, module, "jddcnn", "gbyrn18",
      16 * DT_LOCAL_SIZE_X, r78 * DT_LOCAL_SIZE_Y, r15,
  ...
  const int basic_upsample_1_id = dt_node_add(graph, module, "jddcnn", "gbyrn23",
  ...
  const int direct_conv_12_id = dt_node_add(graph, module, "jddcnn", "gbyrn35",
      1 * DT_LOCAL_SIZE_X, r121 * DT_LOCAL_SIZE_Y, r115,
  ...
  const int basic_activation_12_id = dt_node_add(graph, module, "jddcnn", "gbyrn11",
      8 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r12,
  ...
  const int direct_conv_13_id = dt_node_add(graph, module, "jddcnn", "gbyrn35",
      1 * DT_LOCAL_SIZE_X, r121 * DT_LOCAL_SIZE_Y, r115,
  ...
  const int basic_activation_13_id = dt_node_add(graph, module, "jddcnn", "gbyrn11",
      8 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r12,
  ...
  const int direct_conv_14_id = dt_node_add(graph, module, "jddcnn", "gbyrn6",
      1 * DT_LOCAL_SIZE_X, r121 * DT_LOCAL_SIZE_Y, r115,
  ...
  const int basic_activation_14_id = dt_node_add(graph, module, "jddcnn", "gbyrn11",
      8 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r12,
  ...
  const int basic_upsample_2_id = dt_node_add(graph, module, "jddcnn", "gbyrn36",
  ...
  const int direct_conv_15_id = dt_node_add(graph, module, "jddcnn", "gbyrn37",
      1 * DT_LOCAL_SIZE_X, r138 * DT_LOCAL_SIZE_Y, r132,
  ...
  const int basic_activation_15_id = dt_node_add(graph, module, "jddcnn", "gbyrn8",
      4 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r9,
  ...
  const int direct_conv_16_id = dt_node_add(graph, module, "jddcnn", "gbyrn37",
      1 * DT_LOCAL_SIZE_X, r138 * DT_LOCAL_SIZE_Y, r132,
  ...
  const int basic_activation_16_id = dt_node_add(graph, module, "jddcnn", "gbyrn8",
      4 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r9,
  ...
  const int direct_conv_17_id = dt_node_add(graph, module, "jddcnn", "gbyrn13",
      1 * DT_LOCAL_SIZE_X, r138 * DT_LOCAL_SIZE_Y, r132,
  ...
  const int basic_activation_17_id = dt_node_add(graph, module, "jddcnn", "gbyrn8",
      4 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r9,
  ...
  const int basic_upsample_3_id = dt_node_add(graph, module, "jddcnn", "gbyrn5",
  ...
  const int direct_conv_18_id = dt_node_add(graph, module, "jddcnn", "gbyrn4",
      1 * DT_LOCAL_SIZE_X, r157 * DT_LOCAL_SIZE_Y, r155,
  ...
  const int basic_activation_18_id = dt_node_add(graph, module, "jddcnn", "gbyrn28",
  ...
  const int copy_transform_id = dt_node_add(graph, module, "jddcnn", "gbyrn3",
  ...
  const int copy_transform_1_id = dt_node_add(graph, module, "jddcnn", "gbyrn9",
      1 * DT_LOCAL_SIZE_X, r84 * DT_LOCAL_SIZE_Y, r6,
  ...
  const int direct_conv_19_id = dt_node_add(graph, module, "jddcnn", "gbyrn30",
      1 * DT_LOCAL_SIZE_X, r157 * DT_LOCAL_SIZE_Y, r155,
  ...
  const int basic_activation_19_id = dt_node_add(graph, module, "jddcnn", "gbyrn28",
      1 * DT_LOCAL_SIZE_X, r58 * DT_LOCAL_SIZE_Y, r123,
  ...
  const int direct_conv_20_id = dt_node_add(graph, module, "jddcnn", "gbyrn2",
  ...
  const int basic_activation_20_id = dt_node_add(graph, module, "jddcnn", "gbyrn1",
  ...
  const int memory_slice_id = dt_node_add(graph, module, "jddcnn", "gbyrn0",
