#ifndef jddcnn_gxtrc_DENOX_MODULE_H
#define jddcnn_gxtrc_DENOX_MODULE_H
...
static int denox_read_source_gxtrc(dt_module_t* mod, void* mapped, dt_read_source_params_t* p) {
  if (p->node->kernel == dt_token("weights")) {
    FILE* f = dt_graph_open_resource(mod->graph, 0, "data/jddcnn-gxtrc.dat", "rb");
    if (!f) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: could not find \"data/jddcnn-gxtrc.dat\"");
      return 1;
    }
    fseek(f, 0, SEEK_END);
    ...
    if (size != expected_size) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: weight file \"data/jddcnn-gxtrc.dat\" has unexpected size!");
      fclose(f);
      return 1;
    }
    fseek(f, 0, SEEK_SET);
...
static void denox_create_nodes_gxtrc(dt_graph_t* graph, dt_module_t* module,
  ...
  const int memory_pad_id = dt_node_add(graph, module, "jddcnn", "gxtrc29",
  ...
  const int direct_conv_id = dt_node_add(graph, module, "jddcnn", "gxtrc35",
  ...
  const int basic_activation_id = dt_node_add(graph, module, "jddcnn", "gxtrc25",
  ...
  const int direct_conv_1_id = dt_node_add(graph, module, "jddcnn", "gxtrc22",
      1 * DT_LOCAL_SIZE_X, r153 * DT_LOCAL_SIZE_Y, r151,
  ...
  const int basic_activation_1_id = dt_node_add(graph, module, "jddcnn", "gxtrc21",
  ...
  const int basic_pool_id = dt_node_add(graph, module, "jddcnn", "gxtrc11",
  ...
  const int direct_conv_2_id = dt_node_add(graph, module, "jddcnn", "gxtrc18",
  ...
  const int basic_activation_2_id = dt_node_add(graph, module, "jddcnn", "gxtrc16",
  ...
  const int direct_conv_3_id = dt_node_add(graph, module, "jddcnn", "gxtrc15",
  ...
  const int basic_activation_3_id = dt_node_add(graph, module, "jddcnn", "gxtrc33",
  ...
  const int basic_pool_1_id = dt_node_add(graph, module, "jddcnn", "gxtrc10",
  ...
  const int direct_conv_4_id = dt_node_add(graph, module, "jddcnn", "gxtrc8",
  ...
  const int basic_activation_4_id = dt_node_add(graph, module, "jddcnn", "gxtrc24",
  ...
  const int direct_conv_5_id = dt_node_add(graph, module, "jddcnn", "gxtrc20",
      1 * DT_LOCAL_SIZE_X, r123 * DT_LOCAL_SIZE_Y, r117,
  ...
  const int basic_activation_5_id = dt_node_add(graph, module, "jddcnn", "gxtrc26",
  ...
  const int basic_pool_2_id = dt_node_add(graph, module, "jddcnn", "gxtrc27",
  ...
  const int direct_conv_6_id = dt_node_add(graph, module, "jddcnn", "gxtrc17",
  ...
  const int basic_activation_6_id = dt_node_add(graph, module, "jddcnn", "gxtrc12",
      16 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r15,
  ...
  const int direct_conv_7_id = dt_node_add(graph, module, "jddcnn", "gxtrc30",
  ...
  const int basic_activation_7_id = dt_node_add(graph, module, "jddcnn", "gxtrc31",
  ...
  const int basic_pool_3_id = dt_node_add(graph, module, "jddcnn", "gxtrc23",
  ...
  const int direct_conv_8_id = dt_node_add(graph, module, "jddcnn", "gxtrc13",
  ...
  const int basic_activation_8_id = dt_node_add(graph, module, "jddcnn", "gxtrc32",
  ...
  const int basic_upsample_id = dt_node_add(graph, module, "jddcnn", "gxtrc9",
  ...
  const int direct_conv_9_id = dt_node_add(graph, module, "jddcnn", "gxtrc34",
      1 * DT_LOCAL_SIZE_X, r110 * DT_LOCAL_SIZE_Y, r102,
  ...
  const int basic_activation_9_id = dt_node_add(graph, module, "jddcnn", "gxtrc12",
      16 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r15,
  ...
  const int direct_conv_10_id = dt_node_add(graph, module, "jddcnn", "gxtrc34",
      1 * DT_LOCAL_SIZE_X, r110 * DT_LOCAL_SIZE_Y, r102,
  ...
  const int basic_activation_10_id = dt_node_add(graph, module, "jddcnn", "gxtrc12",
      16 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r15,
  ...
  const int direct_conv_11_id = dt_node_add(graph, module, "jddcnn", "gxtrc17",
      1 * DT_LOCAL_SIZE_X, r110 * DT_LOCAL_SIZE_Y, r102,
  ...
  const int basic_activation_11_id = dt_node_add(graph, module, "jddcnn", "gxtrc12",
      16 * DT_LOCAL_SIZE_X, r80 * DT_LOCAL_SIZE_Y, r15,
  ...
  const int basic_upsample_1_id = dt_node_add(graph, module, "jddcnn", "gxtrc19",
  ...
  const int direct_conv_12_id = dt_node_add(graph, module, "jddcnn", "gxtrc36",
      1 * DT_LOCAL_SIZE_X, r123 * DT_LOCAL_SIZE_Y, r117,
  ...
  const int basic_activation_12_id = dt_node_add(graph, module, "jddcnn", "gxtrc24",
      8 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r12,
  ...
  const int direct_conv_13_id = dt_node_add(graph, module, "jddcnn", "gxtrc36",
      1 * DT_LOCAL_SIZE_X, r123 * DT_LOCAL_SIZE_Y, r117,
  ...
  const int basic_activation_13_id = dt_node_add(graph, module, "jddcnn", "gxtrc24",
      8 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r12,
  ...
  const int direct_conv_14_id = dt_node_add(graph, module, "jddcnn", "gxtrc8",
      1 * DT_LOCAL_SIZE_X, r123 * DT_LOCAL_SIZE_Y, r117,
  ...
  const int basic_activation_14_id = dt_node_add(graph, module, "jddcnn", "gxtrc24",
      8 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r12,
  ...
  const int basic_upsample_2_id = dt_node_add(graph, module, "jddcnn", "gxtrc37",
  ...
  const int direct_conv_15_id = dt_node_add(graph, module, "jddcnn", "gxtrc38",
      1 * DT_LOCAL_SIZE_X, r139 * DT_LOCAL_SIZE_Y, r133,
  ...
  const int basic_activation_15_id = dt_node_add(graph, module, "jddcnn", "gxtrc16",
      4 * DT_LOCAL_SIZE_X, r84 * DT_LOCAL_SIZE_Y, r9,
  ...
  const int direct_conv_16_id = dt_node_add(graph, module, "jddcnn", "gxtrc38",
      1 * DT_LOCAL_SIZE_X, r139 * DT_LOCAL_SIZE_Y, r133,
  ...
  const int basic_activation_16_id = dt_node_add(graph, module, "jddcnn", "gxtrc16",
      4 * DT_LOCAL_SIZE_X, r84 * DT_LOCAL_SIZE_Y, r9,
  ...
  const int direct_conv_17_id = dt_node_add(graph, module, "jddcnn", "gxtrc18",
      1 * DT_LOCAL_SIZE_X, r139 * DT_LOCAL_SIZE_Y, r133,
  ...
  const int basic_activation_17_id = dt_node_add(graph, module, "jddcnn", "gxtrc16",
      4 * DT_LOCAL_SIZE_X, r84 * DT_LOCAL_SIZE_Y, r9,
  ...
  const int basic_upsample_3_id = dt_node_add(graph, module, "jddcnn", "gxtrc7",
  ...
  const int direct_conv_18_id = dt_node_add(graph, module, "jddcnn", "gxtrc5",
      1 * DT_LOCAL_SIZE_X, r153 * DT_LOCAL_SIZE_Y, r151,
  ...
  const int basic_activation_18_id = dt_node_add(graph, module, "jddcnn", "gxtrc28",
  ...
  const int copy_transform_id = dt_node_add(graph, module, "jddcnn", "gxtrc4",
  ...
  const int copy_transform_1_id = dt_node_add(graph, module, "jddcnn", "gxtrc14",
      2 * DT_LOCAL_SIZE_X, r86 * DT_LOCAL_SIZE_Y, r6,
  ...
  const int direct_conv_19_id = dt_node_add(graph, module, "jddcnn", "gxtrc3",
      1 * DT_LOCAL_SIZE_X, r153 * DT_LOCAL_SIZE_Y, r151,
  ...
  const int basic_activation_19_id = dt_node_add(graph, module, "jddcnn", "gxtrc2",
  ...
  const int direct_conv_20_id = dt_node_add(graph, module, "jddcnn", "gxtrc6",
  ...
  const int basic_activation_20_id = dt_node_add(graph, module, "jddcnn", "gxtrc1",
  ...
  const int memory_slice_id = dt_node_add(graph, module, "jddcnn", "gxtrc0",
