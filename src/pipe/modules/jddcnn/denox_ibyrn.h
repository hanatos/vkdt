#ifndef jddcnn_ibyrn_DENOX_MODULE_H
#define jddcnn_ibyrn_DENOX_MODULE_H
...
static int denox_read_source_ibyrn(dt_module_t* mod, void* mapped, dt_read_source_params_t* p) {
  if (p->node->kernel == dt_token("weights")) {
    FILE* f = dt_graph_open_resource(mod->graph, 0, "data/jddcnn-ibyrn.dat", "rb");
    if (!f) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: could not find \"data/jddcnn-ibyrn.dat\"");
      return 1;
    }
    fseek(f, 0, SEEK_END);
    ...
    if (size != expected_size) {
      snprintf(mod->graph->gui_msg_buf, sizeof(mod->graph->gui_msg_buf),
            "jddcnn: weight file \"data/jddcnn-ibyrn.dat\" has unexpected size!");
      fclose(f);
      return 1;
    }
    fseek(f, 0, SEEK_SET);
...
static void denox_create_nodes_ibyrn(dt_graph_t* graph, dt_module_t* module,
  ...
  const int memory_pad_id = dt_node_add(graph, module, "jddcnn", "ibyrn6",
  ...
  const int direct_conv_cm_id = dt_node_add(graph, module, "jddcnn", "ibyrn7",
  ...
  const int direct_conv_cm_1_id = dt_node_add(graph, module, "jddcnn", "ibyrn9",
  ...
  const int direct_conv_cm_2_id = dt_node_add(graph, module, "jddcnn", "ibyrn10",
  ...
  const int direct_conv_cm_3_id = dt_node_add(graph, module, "jddcnn", "ibyrn8",
  ...
  const int direct_conv_cm_4_id = dt_node_add(graph, module, "jddcnn", "ibyrn12",
  ...
  const int direct_conv_cm_5_id = dt_node_add(graph, module, "jddcnn", "ibyrn14",
  ...
  const int direct_conv_cm_6_id = dt_node_add(graph, module, "jddcnn", "ibyrn17",
  ...
  const int direct_conv_cm_7_id = dt_node_add(graph, module, "jddcnn", "ibyrn11",
  ...
  const int direct_conv_cm_8_id = dt_node_add(graph, module, "jddcnn", "ibyrn18",
  ...
  const int direct_conv_cm_9_id = dt_node_add(graph, module, "jddcnn", "ibyrn20",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r68,
  ...
  const int concat_conv_cm_id = dt_node_add(graph, module, "jddcnn", "ibyrn16",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r68,
  ...
  const int direct_conv_cm_10_id = dt_node_add(graph, module, "jddcnn", "ibyrn17",
      1 * DT_LOCAL_SIZE_X, r70 * DT_LOCAL_SIZE_Y, r68,
  ...
  const int direct_conv_cm_11_id = dt_node_add(graph, module, "jddcnn", "ibyrn19",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r80,
  ...
  const int concat_conv_cm_1_id = dt_node_add(graph, module, "jddcnn", "ibyrn15",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r76,
  ...
  const int direct_conv_cm_12_id = dt_node_add(graph, module, "jddcnn", "ibyrn4",
      1 * DT_LOCAL_SIZE_X, r82 * DT_LOCAL_SIZE_Y, r76,
  ...
  const int direct_conv_cm_13_id = dt_node_add(graph, module, "jddcnn", "ibyrn5",
      1 * DT_LOCAL_SIZE_X, r98 * DT_LOCAL_SIZE_Y, r96,
  ...
  const int direct_conv_cm_14_id = dt_node_add(graph, module, "jddcnn", "ibyrn3",
      1 * DT_LOCAL_SIZE_X, r98 * DT_LOCAL_SIZE_Y, r96,
  ...
  const int direct_conv_cm_15_id = dt_node_add(graph, module, "jddcnn", "ibyrn10",
      1 * DT_LOCAL_SIZE_X, r98 * DT_LOCAL_SIZE_Y, r96,
  ...
  const int direct_conv_cm_16_id = dt_node_add(graph, module, "jddcnn", "ibyrn2",
      1 * DT_LOCAL_SIZE_X, r113 * DT_LOCAL_SIZE_Y, r111,
  ...
  const int concat_conv_cm_2_id = dt_node_add(graph, module, "jddcnn", "ibyrn1",
      1 * DT_LOCAL_SIZE_X, r113 * DT_LOCAL_SIZE_Y, r111,
  ...
  const int direct_conv_cm_17_id = dt_node_add(graph, module, "jddcnn", "ibyrn13",
      1 * DT_LOCAL_SIZE_X, r113 * DT_LOCAL_SIZE_Y, r111,
  ...
  const int memory_slice_id = dt_node_add(graph, module, "jddcnn", "ibyrn0",
